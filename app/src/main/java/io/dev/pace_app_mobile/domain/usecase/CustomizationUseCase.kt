...
class CustomizationUseCase @Inject constructor(
    private val repository: ApiRepository
) {
    suspend operator fun invoke(universityId: Long): NetworkResult<CustomizationResponse> {
        return repository.getCustomizationTheme(universityId)
    }
}